  ...
  return (
    <div style={{ minHeight: "100dvh", backgroundColor: "#060810", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      <div style={{ maxWidth: "360px", width: "100%", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "15px", color: "#7d8fa8", lineHeight: 1.6, margin: "0 0 32px" }}>
          Something went wrong during sign-in. This is usually a temporary issue — try again and it should work.
        </p>
        <Link
          href="/diagnose"
          style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", height: "50px", padding: "0 28px", backgroundColor: "#4a9eff", color: "white", fontWeight: 700, fontSize: "15px", borderRadius: "12px", textDecoration: "none", boxShadow: "0 4px 16px rgba(59,130,246,0.3)" }}
        >
          Try Again
        </Link>
        <div style={{ marginTop: "16px" }}>
          <Link href="/" style={{ fontSize: "13px", color: "#4a5c72", textDecoration: "none" }}>
            Back to home
          </Link>
        </div>
      </div>
